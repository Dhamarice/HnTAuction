...
public class Categories extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locations.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Categories.this, Locations.class);
        ...
        upcoming.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Categories.this, UpcomingAuctions.class);
        ...
        btncart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (UserID != null && UserID != ""){
                    ...
                    Intent intent = new Intent(Categories.this, MyBids.class);
                    ...
                    Toast ToastMessage = Toast.makeText(Categories.this, "You are not logged in!", Toast.LENGTH_LONG);
        ...
        btnsearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Categories.this, Search.class);
    ...
    public void loaduielements() {
        ...
        if (dbHandler.getallCategories()!= null) {
            Cursor cursor = dbHandler.getallCategories();
...
//Splitting date formatts
                        ...
                        //if (!(currentDate.after(futureDate))) {
                            ...
                            hzvw.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                            ...
                                            editor.commit();
                                            Intent i = new Intent(Categories.this, Products_list.class);
                ...
                noresult.setText("No auction Categories to show at the moment!");
                noresult.setTextColor(getResources().getColor(R.color.colorAmber));
                noresult.setTypeface(null, Typeface.BOLD);
                Toast.makeText(this, "No auction Categories to show at the moment!", Toast.LENGTH_LONG).show();
