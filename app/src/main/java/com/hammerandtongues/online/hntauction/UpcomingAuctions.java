...
public class UpcomingAuctions extends AppCompatActivity {
    ...
    private String post_id, name, startdate, closedate, splitmonthinwords,discount,deposit, cdatevalue, UserID;
    ...
    private int banner;
    Button category, locations, upcoming;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        category.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(UpcomingAuctions.this, Categories.class);
        ...
        locations.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(UpcomingAuctions.this, Locations.class);
        ...
        upcoming.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(UpcomingAuctions.this, UpcomingAuctions.class);
        ...
        btnhome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(UpcomingAuctions.this, MainActivity.class);
        ...
        btncart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (UserID != null && UserID != ""){
                    ...
                    Intent intent = new Intent(UpcomingAuctions.this, MyBids.class);
                    ...
                    Toast ToastMessage = Toast.makeText(UpcomingAuctions.this, "You are not logged in!", Toast.LENGTH_LONG);
        ...
        btnprofile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(UpcomingAuctions.this, Login.class);
        ...
        btnsearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(UpcomingAuctions.this, Search.class);
...
//Splitting date formatts
                    ...
                    try {
                        ...
                        Date futureDate = dateFormat.parse(startdayserver);
                            ...
                            public void onClick(View view) {
                                ...
                                try {
                                    ...
                                    if (currentDate.after(futureDate)){
                                        ...
                                        editor.commit();
                                        Intent i = new Intent(UpcomingAuctions.this, Products_list.class);
                ...
                if  (mylayout.getChildCount() == 0){
                    ...
                    noresult.setText("There are currently no scheduled upcoming auctions!");
                    noresult.setTypeface(null, Typeface.BOLD);
                    Toast.makeText(this, "There are currently no scheduled upcoming auctions", Toast.LENGTH_LONG).show();
