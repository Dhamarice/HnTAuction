...
public class AllBids extends AppCompatActivity {
    ...
    String Productname, getlastid = "0";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            setContentView(R.layout.content_all_bids);
            ...
            try {
                ...
                Productname = (shared.getString("prname", ""));
                allbids = (Button) findViewById(R.id.btn_allbids);
                allbids.setText(Productname);
            ...
            btnhome.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(AllBids.this, MainActivity.class);
    ...
    public void setuielements() {
        ...
        if (dbHandler.getallBids(productID) != null) {
            Cursor cursor01 = dbHandler.getallBids(productID);
            ...
            if (cursor01 != null && cursor01.moveToFirst()) {
                ...
                for (i = 0; i < i2; i++) {
                    ...
                    PName = cursor01.getString(6);
                    lastid = cursor01.getString(0);
                    post_id = cursor01.getString(1);
                    imgurl = cursor01.getString(8);
                    ppost_id = cursor01.getString(11);
                    bid_amount = cursor01.getString(3);
                    highest_bid = cursor01.getString(12);
                    ...
                    bid_amnt = cursor.getString(6);
                    bid_fromserver = cursor.getString(4);
...
*/
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.menu_search) {
            Intent intent = new Intent(AllBids.this, Search.class);
            startActivity(intent);
            return true;
        }
    ...
    class GetProductDetails extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(AllBids.this);
        ...
        protected String doInBackground(String... args) {
            ...
            int success;
            int catId = 21;
            dbHandler = new DatabaseHelper(AllBids.this);
        ...
        protected void onPostExecute(String posts) {
            ...
            if (posts != null && GetProducts == Boolean.FALSE) {
                ...
                Toast.makeText(AllBids.this, posts, Toast.LENGTH_LONG).show();
            }
